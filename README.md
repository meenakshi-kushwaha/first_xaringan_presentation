This is my first presentation made in R using the xaringan package. I like how clean the presentation looks.Need to tweak .css file to directly add these references to footnote in the presentation.
### Journal Article
